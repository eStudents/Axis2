...
public class InvalidIdentificationNumberFaultException extends java.lang.Exception{
    ...
    private lk.estudents.schemas.xsd.persondata.PersonDataServiceStub.InvalidIdentificationNumberFault faultMessage;
    ...
    public void setFaultMessage(lk.estudents.schemas.xsd.persondata.PersonDataServiceStub.InvalidIdentificationNumberFault msg){
       faultMessage = msg;
    }
    
    public lk.estudents.schemas.xsd.persondata.PersonDataServiceStub.InvalidIdentificationNumberFault getFaultMessage(){
       return faultMessage;
    }
}
